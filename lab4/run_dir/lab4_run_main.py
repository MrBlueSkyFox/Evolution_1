from lab4.Genetic_programming_operators import selection, crossover, mutation, fitness
from lab4.run_dir.side_funct import initialization_population, dataset_generate, bit_dataset_generate
